...
class Sistema:
    ...
    def __init__(self):
        self.janela = ctk.CTk()
        self.width = int(self.janela.winfo_screenwidth())
        self.height = int(self.janela.winfo_screenheight())
        self.x = (5 * self.width) // 10
        self.y = (5 * self.height) // 10
        self.comeco_width = str(int(self.janela.winfo_screenwidth()) // 4)
        self.comeco_height = str(int(self.janela.winfo_screenheight()) // 4)
        self.janela.geometry(f'{self.x}x{self.y}+{self.comeco_width}+{self.comeco_height}')
